...
<div class="modal fade" id="loginIFTTTModal" tabindex="-1" role="dialog" aria-labelledby="Login" aria-hidden="true"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h2 class="modal-title"><img src="./static/images/logos/polito-logged-in.png" height="30" width="30"/>
                    Login with IFTTT Polito</h2>
            </div>
            ...
            <div class="modal-body">
                ...
                <form class="form-horizontal" method="post" action="/progetto/login">
                    <div class="form-group">
                        <label for="inputUsernameIFTTT" class="col-sm-3 control-label">IFTTT Polito Username <span
                                class="glyphicon glyphicon-user" aria-hidden="true"></span></label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="inputUsernameIFTTT" placeholder="Username"
                                   name="username">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="inputPasswordIFTTT" class="col-sm-3 control-label">Password <span
                                class="glyphicon glyphicon-eye-close" aria-hidden="true"></span></label>
                        <div class="col-sm-9">
...
<div class="modal fade" id="loginGoogleModal" tabindex="-1" role="dialog" aria-labelledby="Login" aria-hidden="true"
     style="padding-top: 10%">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div style="text-align: center">
                    <h3 class="modal-title"><img src="./static/images/logos/google-logged-in.png" height="25"
                                                 width="25"/> Login with Google</h3>
                </div>
            </div>
...
<div class="modal fade" id="loginTwitterModal" tabindex="-1" role="dialog" aria-labelledby="Login" aria-hidden="true"
     style="padding-top: 10%">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <!-- <button id="google-auth-btn" type="submit" class="btn btn-default" ng-click="requestGoogleAuth()">Sign in</button> -->
                <div style="text-align: center">
                    <h3 class="modal-title"><img src="./static/images/logos/twitter-logged-in.png" height="45"
                                                 width="45"/> Login with Twitter</h3>
                </div>
            </div>
            <div class="modal-body text-center">
...
<div class="modal fade" id="spinnerModal" tabindex="-1" role="dialog" aria-labelledby="Login" aria-hidden="true"
     style="padding-top: 10%">
...
<nav class="navbar navbar-inverse navbar-fixed-bottom navbar-default center">
    <div class="container">
        ...
        <div class="navbar-header">
            <button type="button" class="navbar-toggle collapsed" data-toggle="collapse"
                    data-target="#bs-navbar-collapse-2" aria-expanded="false">
                <span class="sr-only">Toggle navigation</span>
                <span class="icon-bar"></span>
                <span class="icon-bar"></span>
                <span class="icon-bar"></span>
        ...
        <div class="collapse navbar-collapse navbar-inner" id="bs-navbar-collapse-2">
            <ul class="nav navbar-nav">
                <li><a href="#aboutSite"><span class="glyphicon glyphicon-info-sign" aria-hidden="true"></span> About
                    the site</a></li>
                <li><a href="#ourTeam"><span class="glyphicon glyphicon-cog" aria-hidden="true"></span> The
                    developers</a></li>
                <li><a href="http://www.polito.it" target="_blank"><span class="glyphicon glyphicon-education"
                                                                         aria-hidden="true"></span> PoliTo</a></li>
                <li><a href="https://creativecommons.org" target="_blank">Copyright <span
                        class="glyphicon glyphicon-copyright-mark" aria-hidden="true"></span> IFTTT by PoliTo 2016</a>
                </li>
            </ul>
        </div><!-- /.navbar-collapse -->
    </div><!-- /.container-->
